...
const BuildRiskIndicatorCountListObject = (
  id: string | null,
    ...
    <UIFlexWrapBox key={index} sx={{ gap: 1, alignItems: 'center' }}>
      ...
      >
        ...
        >
          ...
          >
            {index === 0 ? 'and occurs between' : 'or occurs between'}
          </Typography>
        </UIFlexWrapBox>
        <UIDefaultTextField
        ...
        />
        <Typography
          sx={{ fontSize: '13px', color: '#504F54', paddingTop: '10px' }}
        >
          and
        </Typography>
        <UIDefaultTextField
...
const BuildRiskCountList = ({
  ...
  const handleAutocompleteChange = (newVal: string[]): void => {
    handleSyntheticChange({
      operation: 'changeRiskFieldCountingValues',
      targetId: id,
        ...
        <Box sx={{ display: 'flex', gap: 2, flexDirection: 'column' }}>
          {indicator &&
            ...
            indicator?.rangeList?.map((matchItem, index) => {
              return BuildRiskIndicatorCountListObject(
                id,
                matchItem,
                index,
                onOpenHistory,
          ...
          {indicator &&
            ...
            BuildRiskIndicatorCountListObject(
              id,
...
export default BuildRiskCountList;
