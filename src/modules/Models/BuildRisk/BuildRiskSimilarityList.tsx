...
const BuildRiskIndicatorSimilarityListObject = (
  id: string | null,
    ...
    <UIFlexWrapBox key={index} sx={{ gap: 1, alignItems: 'center' }}>
      ...
      >
        ...
        >
          ...
          >
            {index === 0 ? 'has a similarity score between' : 'or between'}
          </Typography>
        </UIFlexWrapBox>
        <UIDefaultTextField
...
const BuildRiskSimilarityList = ({
  ...
  const fieldObject2 = riskFields[dataSourceValue].find(
        ...
        <Box sx={{ display: 'flex', gap: 2, flexDirection: 'column' }}>
          {indicator &&
            ...
            indicator?.rangeList?.map((matchItem, index) => {
              return BuildRiskIndicatorSimilarityListObject(
                id,
                matchItem,
                index,
                onOpenHistory,
          ...
          {indicator &&
            ...
            BuildRiskIndicatorSimilarityListObject(
              id,
...
export default BuildRiskSimilarityList;
