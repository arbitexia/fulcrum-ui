...
const BuildRiskIndicatorUniquenessListObject = (
  id: string | null,
    ...
    <UIFlexWrapBox key={index} sx={{ gap: 1, alignItems: 'center' }}>
      ...
      >
        ...
        >
          ...
          >
            {index === 0 ? 'has between' : 'or between'}
          </Typography>
        </UIFlexWrapBox>
        <UIDefaultTextField
        ...
        <Box sx={{ display: 'flex', gap: 2, flexDirection: 'column' }}>
          {indicator &&
            ...
            indicator?.rangeList?.map((matchItem, index) => {
              return BuildRiskIndicatorUniquenessListObject(
                id,
                matchItem,
                index,
                onOpenHistory,
          ...
          {indicator &&
            ...
            BuildRiskIndicatorUniquenessListObject(
              id,
...
export default BuildRiskUniquenessList;
