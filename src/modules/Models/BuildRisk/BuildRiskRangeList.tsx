...
const BuildRiskIndicatorRangeListObject = (
  id: string | null,
    ...
    <UIFlexWrapBox key={index} sx={{ gap: 1, alignItems: 'center' }}>
      ...
      >
        ...
        >
          ...
          >
            {index === 0 ? 'is between' : 'or between'}
          </Typography>
        </UIFlexWrapBox>
        <UIDefaultTextField
          sx={{ width: '8em', textAlign: 'right' }}
        ...
        <Box sx={{ display: 'flex', gap: 2, flexDirection: 'column' }}>
          {indicator &&
            ...
            indicator?.rangeList?.map((matchItem, index) => {
              return BuildRiskIndicatorRangeListObject(
                id,
                matchItem,
                index,
                onOpenHistory,
          ...
          {indicator &&
            ...
            BuildRiskIndicatorRangeListObject(
              id,
...
export default BuildRiskRangeList;
