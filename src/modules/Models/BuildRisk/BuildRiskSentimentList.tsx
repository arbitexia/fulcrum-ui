...
const BuildRiskIndicatorSentimentListObject = (
  id: string | null,
    ...
    <UIFlexWrapBox key={index} sx={{ gap: 1, alignItems: 'center' }}>
      ...
      >
        ...
        >
          ...
          >
            {index === 0
              ? 'has a negative sentiment score between'
              : 'or between'}
          </Typography>
        </UIFlexWrapBox>
        <UIDefaultTextField
        ...
        <Box sx={{ display: 'flex', gap: 2, flexDirection: 'column' }}>
          {indicator &&
            ...
            indicator?.rangeList?.map((matchItem, index) => {
              return BuildRiskIndicatorSentimentListObject(
                id,
                matchItem,
                index,
                onOpenHistory,
          ...
          {indicator &&
            ...
            BuildRiskIndicatorSentimentListObject(
              id,
...
export default BuildRiskSentimentList;
